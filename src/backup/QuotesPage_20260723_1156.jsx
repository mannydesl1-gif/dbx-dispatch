    ...
    <style>
      ...
      @media print{
        /* Zero the page margin so the browser has no room to inject its own
           date / blob: URL header and footer. Real margins go on body instead. */
        ...
        .header{position:fixed;top:0;left:0;right:0;background:#fff;margin:0;padding:0 12mm 8px;box-sizing:border-box}
