  ...
  const generatePDF = async (quoteData) => {
    ...
    <style>
      ...
      @media print{
        ...
        html{height:100%}
        body{padding:0 14mm 12mm;height:100%;box-sizing:border-box;
        ...
        .page-wrap > tbody > tr > td.page-body{height:100%; vertical-align:top}
        .page-body > .content{
          min-height:100%;
          display:flex; flex-direction:column}
        /* flex-shrink:1 with basis 0 means the spacer NEVER contributes height
           when space is tight — it only expands into space that already exists. */
        .page-body > .content > .flex-spacer{flex:1 1 0; min-height:0}
