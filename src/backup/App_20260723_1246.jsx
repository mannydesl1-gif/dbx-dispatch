...
const RPT_COL_WIDTH = {
  // Phone and Email need enough width to sit on ONE line — these are the two
  // that wrapped badly when every column got equal space.
  "Name": 15, "Role": 6, "Phone": 12, "Email": 22,
  "Licence Class": 7, "Employee ID": 8, "PIN": 5,
...
const RPT_NOWRAP_COLS = new Set(["Phone", "Role", "PIN", "Licence Class", "Employee ID"]);
