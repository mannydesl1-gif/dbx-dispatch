...
function rptPersonCols(cat, records) {
  if (cat === "suppliers") {
    return [RPT_COL_NAME, RPT_COL_ROLE, RPT_COL_PHONE, RPT_COL_EMAIL,
            ...RPT_SUPPLIER_COLS, RPT_COL_ADDRESS, RPT_COL_DOCS];
  }
...
function rptOpenPdf(title, bodyHtml, standaloneHeader = true) {
  ...
  <style>
    ...
    /* table-layout:fixed + word-break stop a wide table from overflowing the
       printable width and clipping the final column. */
