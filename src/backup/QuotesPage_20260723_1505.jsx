    ...
    <style>
      ...
      @media print{
        ...
        .page-wrap > tbody > tr > td.page-body{
          height:1px}                       /* forces the inner div to stretch */
        .page-body > .content{
          /* Letter is 279.4mm tall (NOT A4's 297mm — using 297 here overflowed
             a one-page quote onto two). Header strip ~25mm, footer strip ~19mm,
             leaving ~236mm; 228mm keeps a safety margin so a short quote still
             fits on one page while stretching the footer to the bottom. */
          min-height:228mm;
          display:flex; flex-direction:column}
        .page-body > .content > .flex-spacer{flex:1 1 auto}
