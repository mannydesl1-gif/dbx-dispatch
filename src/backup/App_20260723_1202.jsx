...
function rptOpenPdf(title, bodyHtml) {
  ...
  <style>
    ...
    @media print {
      ...
      /* Reserve room so content doesn't slide under the fixed header.
         Header is ~69px (54px logo + 12px padding + 3px rule); 104px leaves a
         clear gap under the red rule on every page. */
